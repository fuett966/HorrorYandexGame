...
#pragma warning restore 0414 
        ...
        public void UpdatePhase2(float deltaTime)
        {
            ...
            if (BaseVelocity.sqrMagnitude > 0f)
            {
                if (_solveMovementCollisions)
                { 
                    bool bol = InternalCharacterMove(ref BaseVelocity, deltaTime);
                }
                else
                {
                ...
                hitSomethingThisSweepIteration)
            {
                ...
                if (foundClosestHit)
                {
                    ...
                    if (!foundValidStepHit)
                    {
                        ...
                        CharacterController.HitSomethingThisSweepIteration = true;
                ...
                else
                {
                    ...
                    CharacterController.HitSomethingThisSweepIteration = false;
                }
